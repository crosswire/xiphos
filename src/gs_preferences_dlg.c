...
static void get_preferences_from_dlg(GtkWidget * d, SETTINGS * s)
{
	...
	*************************************************************/
	...
	s->showtexts =
	    GTK_TOGGLE_BUTTON(lookup_widget(d, "checkbutton10"))->
	    active;
	s->showcomms =
	    GTK_TOGGLE_BUTTON(lookup_widget(d, "checkbutton11"))->
	    active;
	s->showdicts =
	    GTK_TOGGLE_BUTTON(lookup_widget(d, "checkbutton12"))->
	    active;
...
/*****************************************************************************************/
	...
	gtk_table_attach(GTK_TABLE(table13), label103, 0, 1, 2, 3,
			 (GtkAttachOptions) (GTK_FILL),
			 (GtkAttachOptions) (0), 0, 0);
	...
	gtk_table_attach(GTK_TABLE(table13), label146, 0, 1, 3, 4,
			 (GtkAttachOptions) (GTK_FILL),
			 (GtkAttachOptions) (0), 0, 0);
	...
	gtk_table_attach(GTK_TABLE(table13), gcpCurrentverse, 1, 2, 2,
	...
	gtk_table_attach(GTK_TABLE(table13), gcpTextVerseNums, 1, 2, 3,
	...
	gtk_table_attach(GTK_TABLE(table13), cmbVerseNumSize, 1, 2, 5,
			 6, (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
			 (GtkAttachOptions) (0), 0, 0);
	...
	gtk_table_attach(GTK_TABLE(table13), label147, 0, 1, 4, 5,
			 (GtkAttachOptions) (GTK_FILL),
			 (GtkAttachOptions) (0), 0, 0);
	...
	gtk_table_attach(GTK_TABLE(table13), gcpTextLinks, 1, 2, 4, 5,
			 (GtkAttachOptions) (GTK_FILL),
			 (GtkAttachOptions) (0), 0, 0);
...
/***************************************************************************************/
	...
	gtk_object_set_data_full(GTK_OBJECT(dlgSettings), "frame45",
				 frame45,
				 (GtkDestroyNotify) gtk_widget_unref);
	...
	gtk_object_set_data_full(GTK_OBJECT(dlgSettings), "vbox56",
				 vbox56,
				 (GtkDestroyNotify) gtk_widget_unref);
	...
	checkbutton10 =
	    gtk_check_button_new_with_label(_("Show Bible Texts"));
	gtk_widget_ref(checkbutton10);
	gtk_object_set_data_full(GTK_OBJECT(dlgSettings),
				 "checkbutton10", checkbutton10,
				 (GtkDestroyNotify) gtk_widget_unref);
	gtk_widget_show(checkbutton10);
	gtk_box_pack_start(GTK_BOX(vbox56), checkbutton10, FALSE, FALSE,
			   0);
	...
	checkbutton11 =
	    gtk_check_button_new_with_label(_("Show Commentaries"));
	gtk_widget_ref(checkbutton11);
	gtk_object_set_data_full(GTK_OBJECT(dlgSettings),
				 "checkbutton11", checkbutton11,
				 (GtkDestroyNotify) gtk_widget_unref);
	gtk_widget_show(checkbutton11);
	gtk_box_pack_start(GTK_BOX(vbox56), checkbutton11, FALSE, FALSE,
			   0);
	...
	checkbutton12 =
	    gtk_check_button_new_with_label(_("Show Dictionaries"));
	gtk_widget_ref(checkbutton12);
	gtk_object_set_data_full(GTK_OBJECT(dlgSettings),
				 "checkbutton12", checkbutton12,
				 (GtkDestroyNotify) gtk_widget_unref);
	gtk_widget_show(checkbutton12);
	gtk_box_pack_start(GTK_BOX(vbox56), checkbutton12, FALSE, FALSE,
			   0);
	...
	gtk_table_attach(GTK_TABLE(table9), combo_default_text, 1, 2,
			 15, 16,
			 (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
			 (GtkAttachOptions) (0), 0, 0);
	...
	gtk_tooltips_set_tip(tooltips, entry_default_text,
			     _
			     ("Text Module to use for lookup if none is specified"),
			     NULL);
...
/************************************************************************** start settings */
	...
	gtk_combo_set_popdown_strings(GTK_COMBO(comboDevotion),
				      devotionlist);
	gtk_combo_set_popdown_strings(GTK_COMBO(combo_default_text),
				      biblelist);
	...
	gtk_entry_set_text(GTK_ENTRY(entry_default_text),
			   s->default_text);
