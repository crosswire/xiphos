...
static void
on_cancel_clicked                    (GnomeDialog     *gnomedialog,
                                        gint             arg1,
                                        gpointer         user_data)
{
	g_warning("arg1 = %d",arg1);
...
create_dlgSetup (void)
{
  ...
  GdkColor druidpagestandard3_logo_bg_color = { 0, 45232, 8481, 11822 };
  ...
  GdkColor druidpagestandard1_logo_bg_color = { 0, 8481, 6425, 31354 };
  ...
  GdkColor druidpagestandard2_bg_color = { 0, 44186, 24978, 13159 };
  GdkColor druidpagestandard2_logo_bg_color = { 0, 43193, 25239, 12874 };
  ...
  gtk_object_set_data (GTK_OBJECT (dlgSetup), "dialog_vbox10", dialog_vbox10);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "druidpagestart1", druidpagestart1,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (druidpagestart1);
  gnome_druid_append_page (GNOME_DRUID (druid1), GNOME_DRUID_PAGE (druidpagestart1));
  gnome_druid_set_page (GNOME_DRUID (druid1), GNOME_DRUID_PAGE (druidpagestart1));
  ...
  gnome_druid_page_start_set_title (GNOME_DRUID_PAGE_START (druidpagestart1), _("Welcome To GnomeSword-0.5.0"));
  gnome_druid_page_start_set_text (GNOME_DRUID_PAGE_START (druidpagestart1), _("This guide will take you through the initial setup of GnomeSword"));
  gnome_druid_page_start_set_logo (GNOME_DRUID_PAGE_START (druidpagestart1),
                                   create_image ("gnomesword/GnomeSword.xpm"));

  druidpagestandard3 = gnome_druid_page_standard_new_with_vals ("", NULL);
  gtk_widget_ref (druidpagestandard3);
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "druidpagestandard3", druidpagestandard3,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show_all (druidpagestandard3);
  gnome_druid_append_page (GNOME_DRUID (druid1), GNOME_DRUID_PAGE (druidpagestandard3));
  ...
  gnome_druid_page_standard_set_title (GNOME_DRUID_PAGE_STANDARD (druidpagestandard3), _("GnomeSword-0.5.0"));
  gnome_druid_page_standard_set_logo (GNOME_DRUID_PAGE_STANDARD (druidpagestandard3),
                                      create_image ("gnomesword/GnomeSword.xpm"));

  druid_vbox3 = GNOME_DRUID_PAGE_STANDARD (druidpagestandard3)->vbox;
  gtk_widget_ref (druid_vbox3);
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "druid_vbox3", druid_vbox3,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label112", label112,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label112);
  gtk_box_pack_start (GTK_BOX (vbox27), label112, FALSE, FALSE, 0);

  label113 = gtk_label_new (_("/home/"));
  gtk_widget_ref (label113);
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label113", label113,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label143", label143,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label143);
  gtk_box_pack_start (GTK_BOX (vbox27), label143, FALSE, FALSE, 0);

  label144 = gtk_label_new (_("1.52"));
  gtk_widget_ref (label144);
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label144", label144,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label114", label114,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label114);
  gtk_box_pack_start (GTK_BOX (vbox27), label114, FALSE, FALSE, 0);

  label115 = gtk_label_new (_("/usr/share/sword"));
  gtk_widget_ref (label115);
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label115", label115,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label116", label116,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label116);
  gtk_box_pack_start (GTK_BOX (vbox27), label116, FALSE, FALSE, 0);

  label117 = gtk_label_new (_("0"));
  gtk_widget_ref (label117);
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label117", label117,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label118", label118,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label118);
  gtk_box_pack_start (GTK_BOX (vbox27), label118, FALSE, FALSE, 0);

  label119 = gtk_label_new (_("0"));
  gtk_widget_ref (label119);
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label119", label119,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label119);
  gtk_box_pack_start (GTK_BOX (vbox27), label119, FALSE, FALSE, 0);

  label120 = gtk_label_new (_("Number of Lexicon / Dictionary Modules"));
  gtk_widget_ref (label120);
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label120", label120,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label120);
  gtk_box_pack_start (GTK_BOX (vbox27), label120, FALSE, FALSE, 0);

  label121 = gtk_label_new (_("0"));
  gtk_widget_ref (label121);
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label121", label121,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "druidpagestandard1", druidpagestandard1,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gnome_druid_page_standard_set_title (GNOME_DRUID_PAGE_STANDARD (druidpagestandard1), _("Do you want GnomeSword to open with"));
  gnome_druid_page_standard_set_logo (GNOME_DRUID_PAGE_STANDARD (druidpagestandard1),
                                      create_image ("gnomesword/GnomeSword.xpm"));

  druid_vbox1 = GNOME_DRUID_PAGE_STANDARD (druidpagestandard1)->vbox;
  gtk_widget_ref (druid_vbox1);
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "druid_vbox1", druid_vbox1,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  radiobutton1 = gtk_radio_button_new_with_label (vbox26_group, _("Settings you choose as default"));
  vbox26_group = gtk_radio_button_group (GTK_RADIO_BUTTON (radiobutton1));
  gtk_widget_ref (radiobutton1);
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "radiobutton1", radiobutton1,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (radiobutton1);
  gtk_box_pack_start (GTK_BOX (vbox26), radiobutton1, FALSE, FALSE, 0);

  radiobutton2 = gtk_radio_button_new_with_label (vbox26_group, _("Settings used the last time GnomeSword ran"));
  vbox26_group = gtk_radio_button_group (GTK_RADIO_BUTTON (radiobutton2));
  gtk_widget_ref (radiobutton2);
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "radiobutton2", radiobutton2,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "druidpagestandard2", druidpagestandard2,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gnome_druid_page_standard_set_title (GNOME_DRUID_PAGE_STANDARD (druidpagestandard2), _("Settings to use on first program run"));
  gnome_druid_page_standard_set_logo (GNOME_DRUID_PAGE_STANDARD (druidpagestandard2),
                                      create_image ("gnomesword/GnomeSword.xpm"));

  druid_vbox2 = GNOME_DRUID_PAGE_STANDARD (druidpagestandard2)->vbox;
  gtk_widget_ref (druid_vbox2);
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "druid_vbox2", druid_vbox2,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label104", label104,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "combo_entry4", combo_entry4,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (combo_entry4);

  checkbutton2 = gtk_check_button_new_with_label (_("Use Verse Style                                                                                                       "));
  gtk_widget_ref (checkbutton2);
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "checkbutton2", checkbutton2,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (checkbutton2);
  gtk_table_attach (GTK_TABLE (table7), checkbutton2, 1, 2, 9, 10,
                    (GtkAttachOptions) (0),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (checkbutton2), TRUE);

  checkbutton3 = gtk_check_button_new_with_label (_("Show Interlinear Page                                                                                              "));
  gtk_widget_ref (checkbutton3);
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "checkbutton3", checkbutton3,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (checkbutton3);
  gtk_table_attach (GTK_TABLE (table7), checkbutton3, 1, 2, 11, 12,
                    (GtkAttachOptions) (0),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label140", label140,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label141", label141,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label142", label142,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "combo10", combo10,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "combo11", combo11,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "combo12", combo12,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "combo13", combo13,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label139", label139,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label138", label138,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label107", label107,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_misc_set_alignment (GTK_MISC (label107), 7.45058e-09, 7.45058e-09);

  label106 = gtk_label_new (_("Interlinear 2"));
  gtk_widget_ref (label106);
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label106", label106,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_misc_set_alignment (GTK_MISC (label106), 7.45058e-09, 7.45058e-09);

  label105 = gtk_label_new (_("Interlinear 1"));
  gtk_widget_ref (label105);
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label105", label105,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label105);
  gtk_table_attach (GTK_TABLE (table7), label105, 0, 1, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (GTK_SHRINK), 0, 0);
  gtk_misc_set_alignment (GTK_MISC (label105), 1.2666e-07, 7.45058e-09);

  checkbutton1 = gtk_check_button_new_with_label (_("Auto Save Personal comments                                                                                  "));
  gtk_widget_ref (checkbutton1);
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "checkbutton1", checkbutton1,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (checkbutton1);
  gtk_table_attach (GTK_TABLE (table7), checkbutton1, 1, 2, 10, 11,
                    (GtkAttachOptions) (0),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (checkbutton1), TRUE);

  label111 = gtk_label_new (_("These setting will be the default settings if you chose to use default settings. "));
  gtk_widget_ref (label111);
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "label111", label111,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label111);
  gtk_box_pack_start (GTK_BOX (druid_vbox2), label111, FALSE, FALSE, 0);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgSetup), "druidpagefinish1", druidpagefinish1,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gnome_druid_page_finish_set_title (GNOME_DRUID_PAGE_FINISH (druidpagefinish1), _("GnomeSword-0.5.0"));
  gnome_druid_page_finish_set_text (GNOME_DRUID_PAGE_FINISH (druidpagefinish1), _("            Thank-you for using GnomeSword.\nClick Finish to close this dialog and run GnomeSword."));
  gnome_druid_page_finish_set_logo (GNOME_DRUID_PAGE_FINISH (druidpagefinish1),
                                   create_image ("gnomesword/GnomeSword.png"));

  dialog_action_area10 = GNOME_DIALOG (dlgSetup)->action_area;
  gtk_object_set_data (GTK_OBJECT (dlgSetup), "dialog_action_area10", dialog_action_area10);
  ...
  gtk_button_box_set_spacing (GTK_BUTTON_BOX (dialog_action_area10), 8);
	...
	gtk_signal_connect (GTK_OBJECT (GNOME_DRUID_PAGE (druidpagefinish1)), "finish",
