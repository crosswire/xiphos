...
void on_combobox_parallel_6_changed(GtkComboBox * combobox, gpointer user_data);
void on_combobox_parallel_7_changed(GtkComboBox * combobox, gpointer user_data);
void on_combobox_parallel_8_changed(GtkComboBox * combobox, gpointer user_data);
void on_combobox_parallel_9_changed(GtkComboBox * combobox, gpointer user_data);
void on_combobox_parallel_10_changed(GtkComboBox * combobox, gpointer user_data);
