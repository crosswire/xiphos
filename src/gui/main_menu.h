 ...
 *
 * Copyright (C) 2000-2013 Xiphos Developer Team
 *
...
void on_show_bible_text_activate(GtkCheckMenuItem * menuitem, gpointer user_data);
void on_preview_activate(GtkCheckMenuItem * menuitem, gpointer user_data);
void on_show_commentary_activate(GtkCheckMenuItem * menuitem, gpointer user_data);
void on_show_dictionary_lexicon_activate(GtkCheckMenuItem * menuitem, gpointer user_data);
