...
gui_create_about_trans(void)
{
	...
	GtkWidget *button;
	gchar *about =
	    _("Do you like using GnomeSword to study the Bible? "
	      "Would you like to see its display using your native language? "
	      "You could translate GnomeSword! "
	      "\n\n"
	      "We are always looking for contributions of new "
	      "translations of GnomeSword into other languages. "
	...
	gtk_window_set_title(GTK_WINDOW(dialog_about_trans),
			     _("About GnomeSword Translation"));
	...
	label =
	    gtk_label_new(_
			  ("See TRANSLATION-HOWTO in GnomeSword source"));
	gtk_widget_show(label);
	gtk_box_pack_start(GTK_BOX(vbox), label, FALSE, FALSE, 0);
	gtk_widget_set_usize(label, -2, 24);

	href =
	    gnome_href_new("http://gnomesword.sourceforge.net/hacking-gnomesword.php",
			   _("GnomeSword development"));
