...
void changegroupnameSB ( SETTINGS * s, gchar * groupName,
                         gint groupNum )
{
        GtkWidget *label;
        EShortcutBar *bar1;
                                      ...
                                      gpointer data )
{
        ...
        e_shortcut_model_remove_item ( shortcut_model, group_num,
                                       item_num );
        group_name =
            e_shortcut_model_get_group_name ( shortcut_model,
                                              group_num );
                      ...
                      GdkEvent * event, gint group_num )
{
        ...
        if ( group_num == groupnum0 ) {
                ...
                menuitem =
                    gtk_menu_item_new_with_label ( _( "Add Book" ) );
                gtk_widget_show ( menuitem );
                gtk_menu_append ( GTK_MENU ( menu ), menuitem );
...
{
        gtk_notebook_set_page ( GTK_NOTEBOOK
                                ( GTK_WIDGET ( user_data ) ), 1 );
        changegroupnameSB ( settings, _( "Search Results" ),
                            groupnum7 );
}
...
static GtkWidget *setupVerseListBar ( GtkWidget * vboxVL, SETTINGS * s )
{
        ...
        gtk_box_pack_start ( GTK_BOX ( vboxVL ), frameTB, FALSE, TRUE,
                             0 );
...
*/
        ...
        gtk_box_pack_start ( GTK_BOX ( vbox2 ), frame1, FALSE, TRUE,
                             0 );
...
//-------------------------------------------------------------------------
        ...
        gtk_box_pack_start ( GTK_BOX ( vbox3 ), frameRP, FALSE, TRUE,
                             0 );
        ...
        gtk_container_add ( GTK_CONTAINER ( frameRP ),
                            scrolledwindowRP );
        ...
        gtk_container_add ( GTK_CONTAINER ( scrolledwindowRP ),
                            s->htmlRP );
        ...
        gtk_container_add ( GTK_CONTAINER ( scrolledwindow3 ),
                            clistSearchResults );
        gtk_clist_set_column_width ( GTK_CLIST ( clistSearchResults ),
                                     0, 100 );
        gtk_clist_column_titles_hide ( GTK_CLIST
                                       ( clistSearchResults ) );
...
//-------------------------------------------------------------------------
        ...
        gtk_signal_connect ( GTK_OBJECT ( nbVL ), "switch_page",
                             ...
                             s );
        gtk_signal_connect ( GTK_OBJECT ( clistSearchResults ),
                             "select_row",
                             GTK_SIGNAL_FUNC
...
static void setupSearchBar ( GtkWidget * vp, SETTINGS * s )
{
        ...
        gtk_box_pack_start ( GTK_BOX ( vbox1 ), frame7, FALSE, TRUE,
                             0 );
        ...
        gtk_box_pack_start ( GTK_BOX ( vbox5 ), entrySearch, TRUE, TRUE,
                             0 );
        ...
        gtk_box_pack_start ( GTK_BOX ( vbox5 ), btnSearch, TRUE, FALSE,
                             0 );
        gtk_tooltips_set_tip ( tooltips, btnSearch, _( "Begin Search" ),
                               NULL );
        gtk_button_set_relief ( GTK_BUTTON ( btnSearch ),
                                GTK_RELIEF_HALF );
        ...
        gtk_object_set_data_full ( GTK_OBJECT ( s->app ), "frame2",
                                   ...
                                   gtk_widget_unref );
        gtk_widget_show ( frame2 );
        gtk_box_pack_start ( GTK_BOX ( vbox1 ), frame2, FALSE, TRUE,
                             0 );
        ...
        gtk_box_pack_start ( GTK_BOX ( vbox2 ), rbRegExp, FALSE, FALSE,
                             0 );
        ...
        gtk_box_pack_start ( GTK_BOX ( vbox2 ), p_so->rbPhraseSearch,
                             FALSE, FALSE, 0 );
        ...
        gtk_object_set_data_full ( GTK_OBJECT ( s->app ), "frame3",
                                   ...
                                   gtk_widget_unref );
        gtk_widget_show ( frame3 );
        gtk_box_pack_start ( GTK_BOX ( vbox1 ), frame3, FALSE, TRUE,
                             0 );
        ...
        gtk_object_set_data_full ( GTK_OBJECT ( s->app ), "frame4",
                                   ...
                                   gtk_widget_unref );
        gtk_widget_show ( frame4 );
        gtk_box_pack_start ( GTK_BOX ( vbox1 ), frame4, FALSE, TRUE,
                             0 );
        ...
        gtk_box_pack_start ( GTK_BOX ( vbox4 ), rbNoScope, FALSE, FALSE,
                             0 );
        ...
        gtk_entry_set_text ( GTK_ENTRY ( entryUpper ),
                             _( "Revelation" ) );

        gtk_signal_connect ( GTK_OBJECT ( btnSearch ), "clicked",
                             GTK_SIGNAL_FUNC ( on_btnSearch_clicked ),
                             s );
        gtk_object_set_data ( GTK_OBJECT ( s->app ), "tooltips",
                              tooltips );
}
...
void setupSB ( SETTINGS * s )
{
        ...
        if ( s->showfavoritesgroup ) {
                ...
                tmp =
                    loadshortcutbarSW ( filename, group_name,
                                        icon_size );
...
/*************************************************************************************/
        ...
        gtk_signal_connect ( GTK_OBJECT ( shortcut_model ),
                             "item_removed",
                             GTK_SIGNAL_FUNC ( on_item_removed ),
                             NULL );
        gtk_signal_connect ( GTK_OBJECT ( shortcut_bar ),
                             "shortcut_dragged",
                             GTK_SIGNAL_FUNC ( on_shortcut_dragged ),
                             NULL );
        gtk_signal_connect ( GTK_OBJECT ( shortcut_bar ),
                             "shortcut_dropped",
                             GTK_SIGNAL_FUNC ( on_shortcut_dropped ),
                             NULL );
}
                        ...
                        gchar * modtype )
{
        ...
        while ( glist != NULL ) {
                item =
                    gtk_menu_item_new_with_label ( ( gchar * ) glist->
                                                   data );
                gtk_widget_ref ( item );
                gtk_object_set_data_full ( GTK_OBJECT ( menu ), "item",
                                           item, ( GtkDestroyNotify )
