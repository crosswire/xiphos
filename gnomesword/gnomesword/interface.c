...
create_mainwindow (void)
{
  ...
  tmp_toolbar_icon = gnome_stock_pixmap_widget (mainwindow, GNOME_STOCK_PIXMAP_JUMP_TO);
  tbtnFollow = gtk_toolbar_append_element (GTK_TOOLBAR (tbNotes),
                                GTK_TOOLBAR_CHILD_TOGGLEBUTTON,
                                NULL,
                                "togglebutton1",
  ...
  gtk_object_set_data_full (GTK_OBJECT (mainwindow), "tbtnFollow", tbtnFollow,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  btnSPnew = gtk_toolbar_append_element (GTK_TOOLBAR (toolbar5),
                                GTK_TOOLBAR_CHILD_BUTTON,
                                NULL,
                                "button1",
                                "Start new document", NULL,
                                tmp_toolbar_icon, NULL, NULL);
  gtk_widget_ref (btnSPnew);
  gtk_object_set_data_full (GTK_OBJECT (mainwindow), "btnSPnew", btnSPnew,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_signal_connect (GTK_OBJECT (btnSPnew), "clicked",
                      GTK_SIGNAL_FUNC (on_btnSPnew_clicked),
                      NULL);
...
create_dialog1 (void)
{
  ...
  GdkColor druidpagestandard2_logo_bg_color = { 0, 44204, 17476, 17990 };
  ...
  dialog1 = gnome_dialog_new ("GnomeSword - Setup", NULL);
  gtk_object_set_data (GTK_OBJECT (dialog1), "dialog1", dialog1);
  gtk_container_set_border_width (GTK_CONTAINER (dialog1), 2);
  gtk_window_set_policy (GTK_WINDOW (dialog1), FALSE, FALSE, FALSE);

  dialog_vbox10 = GNOME_DIALOG (dialog1)->vbox;
  gtk_object_set_data (GTK_OBJECT (dialog1), "dialog_vbox10", dialog_vbox10);
  gtk_widget_show (dialog_vbox10);

  druid1 = gnome_druid_new ();
  gtk_widget_ref (druid1);
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "druid1", druid1,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "druidpagestart1", druidpagestart1,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gnome_druid_page_start_set_title (GNOME_DRUID_PAGE_START (druidpagestart1), "Welcome To GnomeSword");
  gnome_druid_page_start_set_text (GNOME_DRUID_PAGE_START (druidpagestart1), "This guide will take you through the initial setup of GnomeSword");
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "druidpagestandard3", druidpagestandard3,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "druid_vbox3", druid_vbox3,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (druid_vbox3);

  vbox27 = gtk_vbox_new (FALSE, 0);
  gtk_widget_ref (vbox27);
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "vbox27", vbox27,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "label112", label112,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "label113", label113,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "label114", label114,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "label115", label115,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "label116", label116,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "label117", label117,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "label118", label118,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "label119", label119,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "label120", label120,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "label121", label121,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "druidpagestandard1", druidpagestandard1,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gnome_druid_page_standard_set_title (GNOME_DRUID_PAGE_STANDARD (druidpagestandard1), "Do you want GnomeSword to open with");
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "druid_vbox1", druid_vbox1,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (druid_vbox1);

  vbox26 = gtk_vbox_new (FALSE, 0);
  gtk_widget_ref (vbox26);
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "vbox26", vbox26,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vbox26);
  gtk_box_pack_start (GTK_BOX (druid_vbox1), vbox26, TRUE, TRUE, 0);

  radiobutton1 = gtk_radio_button_new_with_label (vbox26_group, "Settings you choose as default");
  vbox26_group = gtk_radio_button_group (GTK_RADIO_BUTTON (radiobutton1));
  gtk_widget_ref (radiobutton1);
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "radiobutton1", radiobutton1,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (radiobutton1);
  gtk_box_pack_start (GTK_BOX (vbox26), radiobutton1, FALSE, FALSE, 0);

  radiobutton2 = gtk_radio_button_new_with_label (vbox26_group, "Settings used the last time GnomeSword ran");
  vbox26_group = gtk_radio_button_group (GTK_RADIO_BUTTON (radiobutton2));
  gtk_widget_ref (radiobutton2);
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "radiobutton2", radiobutton2,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "druidpagestandard2", druidpagestandard2,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gnome_druid_page_standard_set_title (GNOME_DRUID_PAGE_STANDARD (druidpagestandard2), "Settings to use on first program run");
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "druid_vbox2", druid_vbox2,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (druid_vbox2);

  table7 = gtk_table_new (8, 2, FALSE);
  gtk_widget_ref (table7);
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "table7", table7,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "label104", label104,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "label105", label105,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "label106", label106,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "label107", label107,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "combo2", combo2,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "combo_entry2", combo_entry2,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (combo_entry2);

  combo3 = gtk_combo_new ();
  gtk_widget_ref (combo3);
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "combo3", combo3,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "combo_entry3", combo_entry3,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (combo_entry3);

  combo4 = gtk_combo_new ();
  gtk_widget_ref (combo4);
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "combo4", combo4,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "combo_entry4", combo_entry4,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (combo_entry4);

  checkbutton1 = gtk_check_button_new_with_label ("Auto Save Personal comments                                                                                 ");
  ...
  checkbutton2 = gtk_check_button_new_with_label ("Use Verse Style                                                                                                       ");
  ...
  checkbutton3 = gtk_check_button_new_with_label ("Show Interlinear Page                                                                                              ");
  gtk_widget_ref (checkbutton3);
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "checkbutton3", checkbutton3,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  checkbutton4 = gtk_check_button_new_with_label ("Show footnotes - with modules that support this feature                                         ");
  gtk_widget_ref (checkbutton4);
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "checkbutton4", checkbutton4,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  label111 = gtk_label_new ("These setting will be the default settings if you chose to use default settings. ");
  gtk_widget_ref (label111);
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "label111", label111,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dialog1), "druidpagefinish1", druidpagefinish1,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  dialog_action_area10 = GNOME_DIALOG (dialog1)->action_area;
  gtk_object_set_data (GTK_OBJECT (dialog1), "dialog_action_area10", dialog_action_area10);
