...
void savebookmark(gchar * item) //-- save a bookmark that has been added to the bookmark menu by the add bookmark item-------dit
{
...
//--------------------------------------------------------------------------------------------
void createFiles(void)		//--------------- create bookmark file nessary for GomeSword if it does not exist
{
	LISTITEM mylist;
	LISTITEM *p_mylist;
	int flbookmarksnew;
...
//-------------------------------------------------------------------------------------------
void saveFile(gchar * filename) //-- save studypad file-----------------------------------------------------------------------it
{
...
//-------------------------------------------------------------------------------------------
void loadFile(GtkWidget * filesel) //-- load file into studypad------------------------------------------------------------------it
{
...
//-------------------------------------------------------------------------------------------
void loadStudyPadFile(gchar * filename) //-- load file into studypad during program startup
{
	GtkWidget *statusbar, *text;
	//gchar filename[255];
	FILE *fp;
...
savelist(gchar * filename, GtkWidget * list) 
{
