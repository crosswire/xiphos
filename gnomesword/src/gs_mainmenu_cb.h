...
extern "C" {
	...
	void on_clear_quickmarks_activate(GtkMenuItem * menuitem,
					  gpointer user_data);
	void on_view_texts1_activate(GtkMenuItem * menuitem,
				     gpointer user_data);
	void on_view_comms1_activate(GtkMenuItem * menuitem,
				     gpointer user_data);
	void on_view_dicts1_activate(GtkMenuItem * menuitem,
				     gpointer user_data);
	...
	void on_preferences1_activate(GtkMenuItem * menuitem,
				      gpointer user_data);
	void on_about_the_sword_project1_activate(GtkMenuItem *
						  menuitem,
						  gpointer user_data);
