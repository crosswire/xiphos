...
static void
on_btkUKok_clicked                     (GtkButton       *button,
                                        gpointer         user_data);
static void
on_btnUKcancel_clicked                 (GtkButton       *button,
                                        gpointer         user_data);
...
create_dlgUnlockKey (void)
{
  ...
  gtk_object_set_data (GTK_OBJECT (dlgUnlockKey), "dlgUnlockKey", dlgUnlockKey);
  gtk_window_set_policy (GTK_WINDOW (dlgUnlockKey), FALSE, FALSE, FALSE);

  dialog_vbox15 = GNOME_DIALOG (dlgUnlockKey)->vbox;
  gtk_object_set_data (GTK_OBJECT (dlgUnlockKey), "dialog_vbox15", dialog_vbox15);
  gtk_widget_show (dialog_vbox15);

  vbox42 = gtk_vbox_new (FALSE, 0);
  gtk_widget_ref (vbox42);
  gtk_object_set_data_full (GTK_OBJECT (dlgUnlockKey), "vbox42", vbox42,
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgUnlockKey), "label177", label177,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (dlgUnlockKey), "entryKey", entryKey,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data (GTK_OBJECT (dlgUnlockKey), "dialog_action_area15", dialog_action_area15);
  ...
  gnome_dialog_append_button (GNOME_DIALOG (dlgUnlockKey), GNOME_STOCK_BUTTON_OK);
  btkUKok = GTK_WIDGET (g_list_last (GNOME_DIALOG (dlgUnlockKey)->buttons)->data);
  gtk_widget_ref (btkUKok);
  gtk_object_set_data_full (GTK_OBJECT (dlgUnlockKey), "btkUKok", btkUKok,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (btkUKok);
  GTK_WIDGET_SET_FLAGS (btkUKok, GTK_CAN_DEFAULT);

  gnome_dialog_append_button (GNOME_DIALOG (dlgUnlockKey), GNOME_STOCK_BUTTON_CANCEL);
  btnUKcancel = GTK_WIDGET (g_list_last (GNOME_DIALOG (dlgUnlockKey)->buttons)->data);
  gtk_widget_ref (btnUKcancel);
  gtk_object_set_data_full (GTK_OBJECT (dlgUnlockKey), "btnUKcancel", btnUKcancel,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_signal_connect (GTK_OBJECT (btnUKcancel), "clicked",
                      GTK_SIGNAL_FUNC (on_btnUKcancel_clicked),
                      NULL);
