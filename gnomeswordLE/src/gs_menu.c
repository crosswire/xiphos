...
static GtkWidget *create_pmComments2(GList * mods)
{
	...
	gtk_object_set_data_full(GTK_OBJECT(pmComments2), "view_in_new_window",
				 view_in_new_window,
				 (GtkDestroyNotify) gtk_widget_unref);
	gtk_widget_show(view_in_new_window);
	gtk_container_add(GTK_CONTAINER(pmComments2), view_in_new_window);
	...
	gtk_container_add(GTK_CONTAINER(pmComments2), separator22);
