...
AC_ARG_WITH([gecko],
	AS_HELP_STRING([--with-gecko@<:@=mozilla|firefox|seamonkey|libxul-embedding|xulrunner@:>@],
...
# Autodetect gecko
_geckos="firefox mozilla-firefox seamonkey mozilla libxul-embedding xulrunner "
